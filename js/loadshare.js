$(document).ready(function(){
   ...
   App.call("getAD",function(res1){
	 ...
	 var url = "http://"+location.host+"/mobile/logined/view/summaryAnnualWork/summaryAnnualWorkTest.html?um="+loginUm;
	 var imageUrl = "http://"+location.host+"/mobile/logined/view/summaryAnnualWork/images/2017.png";
	 console.log('{"title":"年度账单","description":"寿险新渠道年报","url":"'+url+'","imageUrl":"'+imageUrl+'","platform":"1,2,3,4,9,11"}');
     App.call('shareHelper', '{"title":"年度账单","description":"寿险新渠道年报","url":"'+url+'","imageUrl":"'+imageUrl+'","platform":"1,2,3,4,9,11"}');
